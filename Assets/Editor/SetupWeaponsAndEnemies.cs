...
public class SetupWeaponsAndEnemies
{
    ...
    private static void AttachGun(Transform arm, Material gunMat)
    {
        ...
        // Scale to look like a pistol/barrel. The arm is a cylinder (scale y=0.25). 
        // We want the gun to point forward. Arm local space: Y is up-down the cylinder.
        // Assuming arm stands vertical, forward is Z.
        gun.transform.localScale = new Vector3(0.5f, 0.5f, 2f); // relative to arm
        gun.transform.localPosition = new Vector3(0f, -0.8f, 1f); 
        
        // Remove collider so it doesn't block rays/physics
